...
// 17. Dolacz tekst od znaku o podanej pozycji na koniec innego teksu.

int main(void) {
  char text1[100] = "Hello, World!";
  char text2[] = " This is a test.";
  unsigned long long position = 7; // Pozycja od ktorej dolaczamy tekst1 do tekst2
  ...
  // Dolaczenie tekstu od podanej pozycji
